"""Chạy 30 case golden-set (`packages/kb/golden/callisto-handbook-30-draft.yaml`) qua
...
_GOLDEN_SET_PATH = _ROOT / "packages" / "kb" / "golden" / "callisto-handbook-30-draft.yaml"
